...
//IO操作函数
#define IIC_SCL_Clr() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_RESET)	//SCL PB6
#define IIC_SCL_Set() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_SET)

#define IIC_SDA_Clr() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_RESET)	//SDA PB7
#define IIC_SDA_Set() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_SET)

#define READ_SDA 		HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_7) //SDA PB7	
