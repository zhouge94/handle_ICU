...
uint8_t SHT75_DATA_X[8]={0XAA,0XAA,0X04,0X00,0X00,0X00,0X00,0X00};
uint16_t TEM,HUI;
    ...
    unsigned int temp_1,humi_1;
	  ...
	  if(error==0)
	  {
		    ...
		    Calc_SHT75(&humi_2,&temp_2);
			  ...
			  SHT75_DATA_X[3]=HUI/0X100;
			  SHT75_DATA_X[4]=HUI%0X100;
			
			  SHT75_DATA_X[5]=TEM/0X100;
			  SHT75_DATA_X[6]=TEM%0X100;
//			 printf("temputer=%.2f  humi=%.2f\r\n",temp_2,humi_2);
			  HAL_UART_Transmit_DMA(&huart2 , SHT75_DATA_X, 8);	
	  }
}
